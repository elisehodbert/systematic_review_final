...
# Exporting the plot
ggsave(mvts_direct_indirect, file="figures/nb_facilities_nb_mvts/violin_nb_transfers_article.png", width = 30, height = 20, dpi = 600, units = "cm")
...
#### Number of patient transfers (x=networks) ####
...
# Exporting the plot
ggsave(mvts_direct_indirect, file="figures/nb_facilities_nb_mvts/violin_nb_transfers_network.png", width = 30, height = 20, dpi = 600, units = "cm")
