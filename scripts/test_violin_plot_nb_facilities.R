...
# 5. pA : nb_facilities (Subnational vs National) avec violin plots colorés
pA <- df_networks %>%
...
# 6. pB : nb_units (Hospital or group of hospitals) avec violin plots colorés
pB <- df_networks %>%
...
ggsave(fig2, file="figures/violin_nb_facilities_article.png", width = 30, height = 20, dpi = 600, units = "cm")
...
ggsave(fig2, file="figures/violin_nb_facilities_reseau.png", width = 30, height = 20, dpi = 600, units = "cm")
...
### Pour avoir les valeurs des médianes
...
### Médianes en prenant le maximum
